...
if($row>0)
{
	...
	$msg=mysqli_query($con,"insert into users(fname,lname,email,password,contactno,text) values('$fname','$lname','$email','$enc_password','$contact','$text')");
...
<body>
<div class="main">
		<h1>HAVI Registration and Login System for Round-2 </h1>
	 <div class="sap_tabs">	
						...
						<div class="register">
							<form name="registration" method="post" action="" enctype="multipart/form-data">
								...
								<input type="password" value="" name="password" required>
										<p>Contact No. </p>
								<input type="text" value="" name="contact Number"  required>
                                                                <input type="text" value="" name="text" required>
                                                                <input type="date" id="start" name="trip-start" value="2018-07-22" min="1990-01-01" max="2025-01-01"> 
								<div class="sign-up">
